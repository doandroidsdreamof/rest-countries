    ...
    <>
      {currentCards.map((country, id) => (
        <Link to={`/details/${country.cca3}`} >
          <div className={!load ? "hidden" : " card   rounded-md cursor-pointer duration-400 hover:scale-100 ease-in hover:animate-pulse hover:shadow-2xl transition-all  scale-95   h-full shadow-md"}>
            ...
            <div className="card-body px-2 py-6">
              <h1 className={`  text-black   text-2xl`}> {country.name.common}</h1>
